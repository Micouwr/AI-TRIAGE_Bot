...
| Critical | Fallback rate > 5% in 24h, multiple governance script failures | Log, notify governance team, escalate to system owner | System Owner | Clause 5, Clause 6 |
